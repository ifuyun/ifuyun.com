...
export class JdUnionGoodsComponent implements OnInit, OnDestroy {
  ...
  readonly jingfenEliteIds = Object.freeze([
    0, 1, 2, 10, 15, 22, 23, 24, 25, 26, 27, 28, 30, 31, 32, 33, 34, 40, 41,
    108, 109, 110, 112, 125, 129, 130, 153, 210, 238, 247, 249, 315, 340, 341, 342, 343, 345, 346, 426
  ]);
  // 精选-全球购
  readonly otherEliteIds = Object.freeze([
    536, 538, 539, 541, 542, 543, 544, 545, 546, 547, 548, 549,
