...
export class ScrollService {
  ...
  setScrollTop(el: Element | Window, topValue = 0): void {
    if (el === window) {
  ...
  getScroll(target?: Element | HTMLElement | Window | Document | null, top = true): number {
   ...
   * @param options
   */
  scrollTo(containerEl?: Element | HTMLElement | Window | Document | null, y = 0, options: ScrollToOptions = {}): void {
